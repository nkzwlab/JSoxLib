...
public class Publish {
	...
	public Publish() throws Exception {
		...
		SoxConnection con = new SoxConnection("sox.ht.sfc.keio.ac.jp","usera","takuro0928",true); //anonymous login
		//SoxConnection con = new SoxConnection("sox.ht.sfc.keio.ac.jp", "guest","miroguest", true);
		
		SoxDevice soxDevice = new SoxDevice(con, "whitelistTest");
		...
		while (true) {
			...
			value4.setId("text");
			value4.setRawValue("25"); 
			value4.setTypedValue("25");
